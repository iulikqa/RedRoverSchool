package JAVA_OOP_University.Iulian.Lab7;
...
public class EmployeesManager {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("3. Вывести программистов");
    ...
    private static void displayProgrammers() {
        for (EmployeeLab1 employee : employees) {
            if ("программист".equalsIgnoreCase(employee.getPosition())) {
                employee.displayEnoiyeeInfo();
                System.out.println();
            }
        }
